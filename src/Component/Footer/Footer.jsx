  ...
  return (
    <div className="footer">
        <div className="footerWrapper">
            <div className="footerWrapperDetail">
                <Link to="/"><h1>COMPANY LOGO GOES IN HERE</h1></Link> 
            </div>
            <div className="footerWrapperDetails">
                <div>
                    <Link to="/contact" className="hov"><h5>Contact us</h5></Link>
                    <ul>
                ...
                <div>
                    ...
                    <li><Link to="/staff"><span>About us</span></Link></li>
                    </ul>
                </div>
            </div>
        </div>
        <div className="footerBottom">
            <span>CopyWrite &copy; 2022 by Akanni Quadree. All Rights Reserved.</span>
        </div>
